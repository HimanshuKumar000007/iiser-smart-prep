...
window.QUICK_MOCKS_CONFIG = (function () {
    ...
    const chemistryTopics = [
        { name: 'Some Basic Concepts of Chemistry', folder: '1. some-basic-concepts-of-chemistry' },
        { name: 'Structure of the Atom', folder: '2. structure-of-the-atom' },
        { name: 'Classification of Elements and Periodicity', folder: '3. classification-of-elements-and-periodicity-in-properties' },
        { name: 'Chemical Bonding and Molecular Structure', folder: '4. chemical-bonding-and-molecular-structure' },
        { name: 'The d- & f-block elements', folder: '5. d-and-f-block-elements' },
        { name: 'Coordination compounds', folder: '6. coordination-compounds' },
        { name: 'Thermodynamics', folder: '7.thermodynamics' },
        { name: 'Equilibrium', folder: '8. equilibrium' },
