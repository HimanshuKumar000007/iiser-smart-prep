...
template_path = r'd:\IISER_MISSION_MILLIONAIRE_AT_THE_AGE_OF_22\frontend\smart_notes\subjects\short-notes\math\iat-mathematics-sets-and-logic-short-notes.html'
target_path = r'd:\IISER_MISSION_MILLIONAIRE_AT_THE_AGE_OF_22\frontend\smart_notes\subjects\short-notes\math\iat-mathematics-basic-counting-techniques-short-notes.html'

with open(template_path, 'r', encoding='utf-8') as f:
    content = f.read()

# Replace Titles and Meta
content = content.replace('Sets, Relations, and Functions | IISER Smart Prep', 'Basic Counting Techniques & Binomial Theorem | IISER Smart Prep')
content = content.replace('content="Master Sets, Relations, and Functions for the IAT. Comprehensive notes on equivalence relations, function types, and inverse functions."', 'content="Master Basic Counting Techniques, Permutations, Combinations, and the Binomial Theorem for the IAT. Comprehensive short notes and formulas."')
content = content.replace('content="IAT Mathematics, Sets, Relations, Functions, Equivalence Relation, Bijective Function, Injective, Surjective, IISER Aptitude Test, Mathematics Unit 1, Math Short Notes, IISER Smart Prep"', 'content="IAT Mathematics, Basic Counting Techniques, Permutations, Combinations, Factorial, Binomial Theorem, Pascal Triangle, IISER Aptitude Test, Mathematics Unit 1, Math Short Notes, IISER Smart Prep"')
content = content.replace('iat-sets-relations-functions-short-notes.html', 'iat-mathematics-basic-counting-techniques-short-notes.html')
content = content.replace('Sets, Relations, and Functions | IAT Math Short Notes', 'Basic Counting Techniques & Binomial Theorem | IAT Math Short Notes')
content = content.replace('content="Quick revision notes for Sets, Relations, and Functions. Perfect for last-minute IAT preparation."', 'content="Quick revision notes for Basic Counting Techniques and Binomial Theorem. Perfect for last-minute IAT preparation."')
content = content.replace('content="Master Sets, Relations, and Functions for IAT with our expert-curated short notes."', 'content="Master Basic Counting Techniques and Binomial Theorem for IAT with our expert-curated short notes."')
content = content.replace('Sets, Relations, and Functions Short Notes for IAT', 'Basic Counting Techniques Short Notes for IAT')
content = content.replace('description": "Comprehensive revision notes on Sets, Relations, and Functions for students preparing for the IISER Aptitude Test (IAT)."', 'description": "Comprehensive revision notes on Basic Counting Techniques and Binomial Theorem for students preparing for the IISER Aptitude Test (IAT)."')

# Replace Hero
content = content.replace('<h1>Sets, Relations, and Functions</h1>', '<h1>Basic Counting Techniques & Binomial Theorem</h1>')

# Read article and TOC from existing update script logic
